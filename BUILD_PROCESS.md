...
Sơ đồ trực quan kèm theo: **`BUILD_PROCESS.drawio`** (mở bằng draw.io / diagrams.net,
...
`BUILD_PROCESS.drawio` là **một sơ đồ liền mạch duy nhất**, không chia trang. Cuộn từ
