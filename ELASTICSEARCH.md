...
| [`internal/di/injection.go:51-63`](wallet_service/internal/di/injection.go:51) | Khởi tạo client, tạo index lúc boot, cho phép chạy khi ES chết |
| [`internal/biz/wallet_biz.go`](wallet_service/internal/biz/wallet_biz.go) | Đẩy dữ liệu sang ES sau khi ghi MySQL |
| [`internal/controller/wallet_controller.go:100-182`](wallet_service/internal/controller/wallet_controller.go:100) | Nhận gRPC, gọi search, map ra proto |
...
[`biz/wallet_biz.go:180`](wallet_service/internal/biz/wallet_biz.go:180) (`HoldDeposit`, lặp ở dòng 289, 373):
...
Proto [`wallet_messages.proto:79`](api/logistic/wallet_service/v1/wallet_messages.proto:79) có `from_time`/`to_time`, `buildTransactionQuery` đã viết sẵn logic `range` (dòng 306). Nhưng [`wallet_controller.go:145`](wallet_service/internal/controller/wallet_controller.go:145) **không map `req.FromTime` → `params.From`**. Client gửi khoảng thời gian lên, server lặng lẽ bỏ qua.
