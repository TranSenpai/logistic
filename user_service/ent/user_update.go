...
func (_u *UserUpdate) SetStatusReason(v string) *UserUpdate {
	_u.mutation.SetStatusReason(v)
	return _u
}

// SetNillableStatusReason sets the "status_reason" field if the given value is not nil.
func (_u *UserUpdate) SetNillableStatusReason(v *string) *UserUpdate {
	if v != nil {
...
func (_u *UserUpdate) ClearStatusReason() *UserUpdate {
...
func (_u *UserUpdate) SetDriverProfileID(id uuid.UUID) *UserUpdate {
	_u.mutation.SetDriverProfileID(id)
	return _u
}

// SetNillableDriverProfileID sets the "driver_profile" edge to the DriverProfile entity by ID if the given value is not nil.
func (_u *UserUpdate) SetNillableDriverProfileID(id *uuid.UUID) *UserUpdate {
	if id != nil {
...
// SetDriverProfile sets the "driver_profile" edge to the DriverProfile entity.
func (_u *UserUpdate) SetDriverProfile(v *DriverProfile) *UserUpdate {
	return _u.SetDriverProfileID(v.ID)
}

// SetShipperProfileID sets the "shipper_profile" edge to the ShipperProfile entity by ID.
func (_u *UserUpdate) SetShipperProfileID(id uuid.UUID) *UserUpdate {
	_u.mutation.SetShipperProfileID(id)
	return _u
}

// SetNillableShipperProfileID sets the "shipper_profile" edge to the ShipperProfile entity by ID if the given value is not nil.
func (_u *UserUpdate) SetNillableShipperProfileID(id *uuid.UUID) *UserUpdate {
	if id != nil {
		_u = _u.SetShipperProfileID(*id)
	}
	return _u
}

// SetShipperProfile sets the "shipper_profile" edge to the ShipperProfile entity.
func (_u *UserUpdate) SetShipperProfile(v *ShipperProfile) *UserUpdate {
	return _u.SetShipperProfileID(v.ID)
}
...
func (_u *UserUpdate) ClearShipperProfile() *UserUpdate {
	_u.mutation.ClearShipperProfile()
	return _u
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.StatusReasonCleared() {
		_spec.ClearField(user.FieldStatusReason, field.TypeString)
	}
	...
	if _u.mutation.ShipperProfileCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.ShipperProfileTable,
			Columns: []string{user.ShipperProfileColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := _u.mutation.ShipperProfileIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   user.ShipperProfileTable,
...
// SetStatusReason sets the "status_reason" field.
func (_u *UserUpdateOne) SetStatusReason(v string) *UserUpdateOne {
	_u.mutation.SetStatusReason(v)
	return _u
}

// SetNillableStatusReason sets the "status_reason" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableStatusReason(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetStatusReason(*v)
	}
	return _u
...
// ClearStatusReason clears the value of the "status_reason" field.
func (_u *UserUpdateOne) ClearStatusReason() *UserUpdateOne {
	_u.mutation.ClearStatusReason()
	return _u
}
...
// SetDriverProfileID sets the "driver_profile" edge to the DriverProfile entity by ID.
func (_u *UserUpdateOne) SetDriverProfileID(id uuid.UUID) *UserUpdateOne {
	_u.mutation.SetDriverProfileID(id)
	return _u
}

// SetNillableDriverProfileID sets the "driver_profile" edge to the DriverProfile entity by ID if the given value is not nil.
func (_u *UserUpdateOne) SetNillableDriverProfileID(id *uuid.UUID) *UserUpdateOne {
	if id != nil {
		_u = _u.SetDriverProfileID(*id)
	}
	return _u
...
// SetDriverProfile sets the "driver_profile" edge to the DriverProfile entity.
func (_u *UserUpdateOne) SetDriverProfile(v *DriverProfile) *UserUpdateOne {
	return _u.SetDriverProfileID(v.ID)
}

// SetShipperProfileID sets the "shipper_profile" edge to the ShipperProfile entity by ID.
func (_u *UserUpdateOne) SetShipperProfileID(id uuid.UUID) *UserUpdateOne {
	_u.mutation.SetShipperProfileID(id)
	return _u
}

// SetNillableShipperProfileID sets the "shipper_profile" edge to the ShipperProfile entity by ID if the given value is not nil.
func (_u *UserUpdateOne) SetNillableShipperProfileID(id *uuid.UUID) *UserUpdateOne {
	if id != nil {
		_u = _u.SetShipperProfileID(*id)
	}
	return _u
...
// SetShipperProfile sets the "shipper_profile" edge to the ShipperProfile entity.
func (_u *UserUpdateOne) SetShipperProfile(v *ShipperProfile) *UserUpdateOne {
	return _u.SetShipperProfileID(v.ID)
}
...
// ClearShipperProfile clears the "shipper_profile" edge to the ShipperProfile entity.
func (_u *UserUpdateOne) ClearShipperProfile() *UserUpdateOne {
	_u.mutation.ClearShipperProfile()
	return _u
}
