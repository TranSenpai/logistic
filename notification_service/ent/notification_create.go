...
func (_c *NotificationCreate) SetRecipientRole(v notification.RecipientRole) *NotificationCreate {
	_c.mutation.SetRecipientRole(v)
	return _c
}

// SetNillableRecipientRole sets the "recipient_role" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableRecipientRole(v *notification.RecipientRole) *NotificationCreate {
	if v != nil {
		_c.SetRecipientRole(*v)
	}
	return _c
}
...
func (_c *NotificationCreate) SetRefType(v string) *NotificationCreate {
	_c.mutation.SetRefType(v)
	return _c
}

// SetNillableRefType sets the "ref_type" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableRefType(v *string) *NotificationCreate {
	if v != nil {
		_c.SetRefType(*v)
	}
	return _c
...
func (_c *NotificationCreate) SetRefID(v string) *NotificationCreate {
	_c.mutation.SetRefID(v)
	return _c
}

// SetNillableRefID sets the "ref_id" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableRefID(v *string) *NotificationCreate {
	if v != nil {
		_c.SetRefID(*v)
	}
	return _c
...
func (_c *NotificationCreate) SetErrorMessage(v string) *NotificationCreate {
	_c.mutation.SetErrorMessage(v)
	return _c
}

// SetNillableErrorMessage sets the "error_message" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableErrorMessage(v *string) *NotificationCreate {
	if v != nil {
...
func (_c *NotificationCreate) defaults() {
	if _, ok := _c.mutation.RecipientRole(); !ok {
		v := notification.DefaultRecipientRole
		_c.mutation.SetRecipientRole(v)
	}
...
func (_c *NotificationCreate) check() error {
	...
	if _, ok := _c.mutation.RecipientRole(); !ok {
		return &ValidationError{Name: "recipient_role", err: errors.New(`ent: missing required field "Notification.recipient_role"`)}
	}
	if v, ok := _c.mutation.RecipientRole(); ok {
