...
func (*Transaction) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case transaction.FieldAmount, transaction.FieldTransactionType, transaction.FieldStatus:
			values[i] = new(sql.NullInt64)
		case transaction.FieldReferenceID, transaction.FieldDescription:
			values[i] = new(sql.NullString)
		case transaction.FieldCreatedAt, transaction.FieldUpdatedAt, transaction.FieldDeletedAt:
			values[i] = new(sql.NullTime)
		case transaction.FieldID, transaction.FieldCreatedBy, transaction.FieldUpdatedBy, transaction.FieldWalletID:
	...
	for i := range columns {
		...
		case transaction.FieldTransactionType:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				...
				_m.TransactionType = uint8(value.Int64)
			}
